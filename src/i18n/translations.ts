...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    digital: {
      ...
      title: "Work faster, simpler processes",
      desc: "We tidy up your workflows, automate repetitive tasks, and connect the tools you use—with AI and easy‑to‑read reports.",
      features: {
        automationTitle: "Automation",
        automationDesc:
          "Repetitive work runs on its own—faster and more consistent.",
        aiAssistTitle: "AI Assist",
        aiAssistDesc: "AI helps check data and suggest improvements.",
        integrationTitle: "Connect apps",
        integrationDesc: "Link your tools so they share data.",
        analyticsTitle: "Reports",
        analyticsDesc: "Clear dashboards and reports.",
      },
      steps: {
        mapTitle: "Understand the process",
        mapDesc: "Map the workflow and roles.",
        designTitle: "Design the steps",
        designDesc: "Forms, approvals, and deadlines.",
        automateTitle: "Automation",
        automateDesc: "Set rules, triggers, and notifications.",
        orchestrateTitle: "Connect systems",
        orchestrateDesc: "So data flows automatically.",
      },
    },
    tech: {
      pill: "Tech Stack",
  ...
  id: {
    ...
    digital: {
      ...
      title: "Kerja lebih cepat, proses lebih sederhana",
      desc: "Kami membantu merapikan alur kerja, mengerjakan tugas berulang secara otomatis, dan menghubungkan alat yang Anda pakai—semuanya dibantu AI dan laporan yang mudah dipahami.",
      features: {
        automationTitle: "Otomatisasi",
        automationDesc:
          "Pekerjaan berulang jalan sendiri, lebih cepat dan konsisten.",
        aiAssistTitle: "Bantuan AI",
        aiAssistDesc: "AI membantu cek data dan memberi saran.",
        integrationTitle: "Sambungkan aplikasi",
        integrationDesc:
          "Hubungkan alat yang Anda pakai agar saling berbagi data.",
        analyticsTitle: "Laporan",
        analyticsDesc: "Laporan dan dashboard yang mudah dibaca.",
      },
      steps: {
        mapTitle: "Pahami proses",
        mapDesc: "Gambarkan alur kerja dan perannya.",
        designTitle: "Rancang langkah",
        designDesc: "Formulir, persetujuan, dan batas waktu.",
        automateTitle: "Otomatisasi",
        automateDesc: "Atur aturan, pemicu, dan notifikasi.",
        orchestrateTitle: "Satukan sistem",
        orchestrateDesc: "Sambungkan agar data mengalir otomatis.",
      },
    },
    tech: {
